...
def dialog_config(op):
    ...
    text = '\n'.join(
        (
                                    ...
                                    + [
                                        c1.join(
                                            [
                                                ...
                                                'cap='
                                                + _(
                                                    '&Load on app start, reopen last project (*)'
                                                ),
                                                'val=0',
                                                'en=0',
                                            ]
                                    ...
                                    + [
                                        c1.join(
                                            [
                                                ...
                                                'cap='
                                                + _(
                                                    'On opening file in Git/SVN repo, create project from repo (*)'
                                                ),
                                                'val='
                                                + bool_to_str(
                                                    op.get('check_git', True)
                                                ),
                                            ]
                                        )
                                    ]
                        ...
                        + [
                            c1.join(
                                [
                                    ...
                                    'cap='
                                    + _(
                                        'For more icons, get add-ons of kind "filetypeicons", "projtoolbaricons"'
                                    ),
                                ]
                            )
                        ]
                    ...
                    + [
                        c1.join(
                            [
                                'type=label',
                                'pos=6,470,600,0',
                                'cap=' + _('(*) - requires CudaText restart'),
                            ]
                        )
                    ]
                )
            ...
            + [
                c1.join(
                    ['type=button', 'pos=406,500,502,0', 'cap=' + _('Cancel')]
                )
            ]
        )
    )
...
def dialog_proj_prop(prop):
    ...
    text = '\n'.join(
        (
                    ...
                    + [
                        c1.join(
                            [
                                'type=label',
                                'pos=6,6,500,0',
                                'cap=' + _('&Variables (in form Name=Value)'),
                            ]
                        )
                    ]
                    + [
                    ...
                    + [
                        c1.join(
                            [
                                ...
                                'cap='
                                + _(
                                    '&Main file (read-only, change in context menu)'
                                ),
                            ]
                        )
                    ]
            ...
            + [
                c1.join(
                    ['type=button', 'pos=406,300,502,0', 'cap=' + _('Cancel')]
                )
            ]
        )
    )
