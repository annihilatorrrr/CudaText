...
def is_correct_id(name):
    if not name:
        return False
    if name[0] not in f'{string.ascii_letters}_':
        return False
    chars = string.ascii_letters+string.digits+'_'
    return all(s in chars for s in name)

def get_module_dir():
    dir = app_path(APP_DIR_PY)
    for i in range(2000):
        name = f'test{str(i+1)}'
        if not os.path.isdir(os.path.join(dir, f'cuda_{name}')):
            return name
    return 'test'
                                                    ...
                                                    + [
                                                        c1.join(
                                                            [
                                                                ...
                                                                'cap='
                                                                + _(
                                                                    '&Python module name without "cuda_":'
                                                                ),
                                                                'pos=6,54,450,0',
                                                            ]
                                                        )
                                            ...
                                            + [
                                                c1.join(
                                                    [
                                                        ...
                                                        'cap='
                                                        + _(
                                                            '&Commands "Caption>method" ("-" at end: without menu item):'
                                                        ),
                                                        'pos=6,102,450,0',
                                                    ]
                                                )
                                    ...
                                    + [
                                        c1.join(
                                            [
                                                ...
                                                'cap='
                                                + _(
                                                    '&Add "Config" menu item to "Options / Settings-plugins"'
                                                ),
                                                'pos=6,246,450,0',
                                            ]
                                        )
